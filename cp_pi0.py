...
class FinetuneConfig:
    ...
    vla_path: str = os.environ.get("PI0_CHECKPOINT_PATH", "checkpoints/pi0_fast_libero")  # Pi0 checkpoint path
    ...
    cycle_dataloader: bool = False                                  # Repeat the finite RLDS iterator until max_steps
...
def train_up(cfg: FinetuneConfig) -> None:
    ...
    tokenizer = _tokenizer.PaligemmaTokenizer(max_len=train_config.model.max_token_len)
